...
<div class="container-fluid">
    <div>
        ...
        <form method="post"
            ...
            <div>
                <label for="name">
                    <fmt:message key="tours.update.name.label"/>
                </label>
                <input class="form-control"
                       id="name"
                       name="name"
                       value="${requestScope.tour.name}"
                       placeholder="<fmt:message key="tours.update.name.placeholder"/> "
                       type="text"
                       required/>
            ...
            <div>
                <label for="tourType">
                    <fmt:message key="tours.update.type.label"/>
                </label>
            ...
            <div>
                <label for="hotelType">
                    <fmt:message key="tours.update.hoteltype.label"/>
                </label>
                <select class="form-control"
                        id="hotelType"
                        name="hotelType">
            ...
            <div>
                <label for="groupSize">
                    <fmt:message key="tours.update.groupsize.label"/>
                </label>
                <input class="form-control"
                       id="groupSize"
                       name="groupSize"
                       value="${requestScope.tour.groupSize}"
                       placeholder="<fmt:message key="tours.update.groupsize.label"/>"
                       type="number"
                       required/>
                <span class="text-danger">
            ...
            <div>
                <label for="price">
                    <fmt:message key="tours.update.price.label"/>
                </label>
                <input class="form-control"
                       id="price"
                       name="price"
                       value="${requestScope.tour.price}"
                       placeholder="<fmt:message key="tours.update.price.placeholder"/>"
                       type="number"
                       required/>
                <span class="text-danger">
